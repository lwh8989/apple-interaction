    ...
    const sceneInfo = [
        ...
        },
        {
            ...
            objs: {
                ...
                messageA: document.querySelector('#scroll-section-2 .active-2-a'),
                messageB: document.querySelector('#scroll-section-2 .active-2-b'),
                messageC: document.querySelector('#scroll-section-2 .active-2-c'),
                pinB: document.querySelector('#scroll-section-2 .active-2-b .pin'),
                pinC: document.querySelector('#scroll-section-2 .active-2-c .pin')
            },
            values: {
